...
var pickout = (function(){
	...
	function fireModal(config){
		...
		var modal = document.querySelector('.pk-modal'),
			...
			headView = document.querySelector('.pk-head'),
			data;
		...
		if(config.head){
            headView.setAttribute('class', headView.getAttribute('class') + ' -show');
            var title = select.hasAttribute('placeholder') ? select.getAttribute('placeholder') : 'Select to option';
            headView.querySelector('.head').innerHTML = title;
		}
		// If search
		if(config.search) {
	...
	function prepareModal(){
        ...
        var headView = document.createElement('div');
        headView.setAttribute('class', 'pk-head');
        ...
        modal.appendChild(headView);
        headView.appendChild(head);
		search.appendChild(inputSearch);
        headView.appendChild(close);
